...
golem::add_module(name = "Overview", with_test = FALSE) # Name of the module
golem::add_module(name = "Design", with_test = FALSE) # Name of the module
golem::add_module(name = "Specification", with_test = FALSE) # Name of the module
