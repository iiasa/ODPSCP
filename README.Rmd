...
[![](https://img.shields.io/badge/Shiny-shinyapps.io-447099"?style=flat&labelColor=white&logo=Posit&logoColor=447099")](https://martinjung.shinyapps.io/ODPSCP/)
...
This repository contains the shiny app behind the package and can be visualized on [https://odpscp.iiasa.ac.at/](https://odpscp.iiasa.ac.at/) where it will remain hosted.
...
It is also possible to run the shiny-interface locally. To do so, you need to install the package from GitHub:
...
The code is open source and contributions are welcome. The code is licensed under the [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/). The interface has been created in *R-shiny* with the help of the *golem* framework for production- ready shiny interfaces. It uses
